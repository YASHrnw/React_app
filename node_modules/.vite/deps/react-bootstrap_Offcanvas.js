...
var Context = (0, import_react10.createContext)(canUseDOM_default ? window : void 0);
...
function useMergedRefs(refA, refB) {
  return (0, import_react12.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var context = React12.createContext(null);
...
var AbstractModalHeader = React14.forwardRef(({
  ...
  const context2 = (0, import_react21.useContext)(ModalContext_default);
...
var divWithClassName_default = (className) => React16.forwardRef((p, ref) => (0, import_jsx_runtime14.jsx)("div", {
  ...p,
  ref,
...
var Offcanvas = React18.forwardRef(({
  ...
  const modalManager = (0, import_react22.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react22.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react22.useState)(false);
  ...
  const modalContext = (0, import_react22.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react22.useCallback)((backdropProps) => (0, import_jsx_runtime16.jsx)("div", {
    ...backdropProps,
